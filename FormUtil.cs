        ...
        public static void SaveBookInfo(Book book,TreeNode node)
        {
            ...
            try
            {
                ...
                if (selectNode != null)
                {
                    ...
                    XmlElement press = xmlDoc.CreateElement("press");
                    press.InnerText = book.Press;
                    ...
                    selectNode.AppendChild(isbn);
                    selectNode.AppendChild(author);
                    selectNode.AppendChild(price);
                    selectNode.AppendChild(press);
